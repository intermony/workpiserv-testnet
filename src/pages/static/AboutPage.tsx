export default function AboutPage() {
  return (
    <div className="section-container py-16 max-w-3xl mx-auto">
      <h1 className="font-heading font-bold text-3xl text-navy mb-4">About WorkPiServ</h1>
      <p className="text-muted-foreground mb-6">WorkPiServ is the first global secure freelance marketplace powered by Pi Network. We connect talented freelancers with clients worldwide, enabling secure transactions through our smart Escrow system.</p>
      ...
      <div className="rounded-2xl border border-border bg-card p-5 text-muted-foreground space-y-2">
        <p>
          WorkPiServ charges a flat <strong className="text-navy">10% platform commission</strong> on each
        ...
        <p>
          ...
          <strong className="text-navy"> π 9</strong> and WorkPiServ keeps <strong className="text-navy">π 1</strong>.
        </p>
        <p>
