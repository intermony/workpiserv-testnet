export default function TermsPage() {
  return (
    <div className="section-container py-16 max-w-3xl mx-auto">
      ...
      <p className="text-muted-foreground mb-6">
        An order can be cancelled and refunded if the seller has not started work within the agreed timeframe.
      </p>
      <h2 className="font-heading font-bold text-xl text-navy mb-3">7. Contact Us</h2>
