    ...
    <div className="animate-fade" style={{maxWidth:'700px',margin:'0 auto',padding:'1rem'}}>
      ...
      {loading ? (
        ...
        <div style={{display:'flex',flexDirection:'column',gap:'0.75rem'}}>
          {notifications.map(n => (
            <div key={n._id} style={{
              background: n.read ? 'var(--bg-card,#1e293b)' : 'rgba(99,102,241,0.08)',
              border: `1px solid ${n.read ? 'rgba(255,255,255,0.08)' : 'rgba(99,102,241,0.3)'}`,
              ...
              <div
                ...
                style={{
                  ...
                  background: activeConv?.partnerId === conv.partnerId
                    ? 'rgba(10,36,99,0.06)' : 'transparent',
                  transition: 'background 0.2s',
                }}
              >
                {/* Avatar */}
                <div style={{
                  ...
                  background: 'linear-gradient(135deg, #0A2463, #F4801A)',
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <span style={{ fontWeight: 700, fontSize: '0.9rem', color: '#0A2463' }}>
        ...
        {activeConv && (
          <div style={chatStyle}>
            ...
            <div style={{
              ...
              <div>
                <p style={{ margin: 0, fontWeight: 700, fontSize: '0.9rem', color: '#0A2463' }}>
                  {activeConv.partner?.username}
                </p>
                <p style={{ margin: 0, fontSize: '0.72rem', color: '#10b981' }}>● En ligne</p>
              </div>
            </div>
                  ...
                  return (
                    <div key={m._id || i} style={{
                      ...
                      <div style={{
                        ...
                        background: isMe
                          ? 'linear-gradient(135deg, #0A2463, #1B4F8A)'
                          : '#fff',
                        color: isMe ? '#fff' : '#0A2463',
                        fontSize: '0.875rem',
                        lineHeight: 1.5,
                        boxShadow: '0 2px 8px rgba(0,0,0,0.08)',
                        border: isMe ? 'none' : '1px solid rgba(10,36,99,0.1)',
                      }}>
            ...
            <div style={{
              padding: '0.875rem 1rem',
              background: '#fff',
              borderTop: '1px solid rgba(10,36,99,0.1)',
              ...
              <button
                ...
                style={{
                  ...
                  background: text.trim()
                    ? 'linear-gradient(135deg, #F4801A, #C9610A)'
                    : 'rgba(10,36,99,0.1)',
...
const LoginModal = ({ isOpen, onClose, onLogin, onPiLogin, T }) => {
  ...
  const cardStyle = (r) => ({
    border: `2px solid ${type === r.value ? r.color : 'rgba(255,255,255,0.1)'}`,
    borderRadius: '16px',
    padding: '1.25rem',
    cursor: 'pointer',
    background: type === r.value ? `${r.color}22` : 'rgba(255,255,255,0.04)',
  ...
  return (
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal" style={{textAlign:'center', background:'#0f172a', color:'#f1f5f9'}}>
        <div className="modal-header">
          ...
          <>
            ...
            <div style={{display:'flex', gap:'1rem', marginBottom:'1.5rem'}}>
              {roles.map(r => (
                <div key={r.value} style={cardStyle(r)} onClick={() => setType(r.value)}>
                  ...
                  <div style={{fontSize:'0.75rem', color:'#94a3b8', lineHeight:1.5}}>{r.desc}</div>
                  {type === r.value && (
                    <div style={{
            ...
            <button onClick={onPiLogin} className="btn btn-primary btn-lg"
              style={{width:'100%', marginBottom:'1rem',
                background:'linear-gradient(135deg,#7B4FBE,#6366f1)',
                boxShadow:'0 8px 24px rgba(99,102,241,0.35)', border:'none'}}>
            ...
            <div style={{margin:'1rem 0', position:'relative'}}>
              ...
              <span style={{
                ...
                padding:'0 1rem', color:'#64748b', fontSize:'0.8rem'
        ...
        {step === 2 && (
          <>
            <div style={{
              ...
              border: `1px solid ${type==='freelancer' ? '#F4801A' : '#1B4F8A'}`,
              borderRadius:'20px', padding:'4px 14px', marginBottom:'1.25rem',
              fontSize:'0.8rem', fontWeight:600,
              color: type==='freelancer' ? '#F4801A' : '#60a5fa'
            }}>
