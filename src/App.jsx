...
const ServiceCard = ({ service, onClick, T }) => {
  ...
  const accent = ACCENT_MAP[service.category] || '#7C3AED';
  return (
    <div
      onClick={onClick}
      ...
      style={{
        background: hovered ? '#13131f' : '#111118',
        border: `1.5px solid ${hovered ? accent : '#1e1e2e'}`,
    ...
    >
      <div style={{ height:'140px', background:`linear-gradient(135deg,${accent}33,#0f0f1a)`, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'3rem', position:'relative', overflow:'hidden' }}>
        {service.image || '🎯'}
      ...
      <div style={{ padding:'1rem', flex:1, display:'flex', flexDirection:'column' }}>
        <div style={{ display:'flex', alignItems:'center', gap:'8px', marginBottom:'0.625rem' }}>
          ...
          <div>
            <div style={{ fontWeight:600,fontSize:'0.8rem',color:'#c8c8e0' }}>{service.freelancerId?.username||'—'}</div>
            <div style={{ color:'#F59E0B',fontSize:'0.7rem' }}>{'★'.repeat(Math.floor(service.rating||0))} <span style={{color:'#555577'}}>{service.rating||0}</span></div>
          </div>
        </div>
        <h3 style={{ fontFamily:"'Syne','Montserrat',sans-serif",fontWeight:700,fontSize:'0.9rem',color:'#f1f0f8',lineHeight:1.3,margin:'0 0 0.5rem 0',flex:1 }}>
          {service.title?.substring(0,55)}{service.title?.length > 55 ? '…' : ''}
        </h3>
        <div style={{ display:'flex',alignItems:'center',justifyContent:'space-between',paddingTop:'0.625rem',borderTop:'1px solid #1a1a2e' }}>
          <span style={{ color:'#555577',fontSize:'0.72rem' }}>⏱️ {service.deliveryDays} {T.daysLabel||'j'}</span>
          <span style={{ fontFamily:"'Syne','Montserrat',sans-serif",fontWeight:800,fontSize:'1rem',color:'#fff' }}>
...
const HomePage = ({ navigate, T, user }) => {
  ...
  const categories = [
    { key: 'catDesign',    icon: '🎨', accent: '#7C3AED', label: T.catDesign    || 'Design' },
  ...
  const sectionTitle = {
    ...
    fontWeight: 800, fontSize: '1.05rem', color: '#f1f0f8',
  ...
  return (
    <div className="animate-fade" style={{ background: '#080810', minHeight: '100vh', paddingBottom: '2rem' }}>

      {/* ── HERO BANNER ── */}
      <div style={{
        margin: '1rem', padding: '1.75rem 1.25rem',
        background: 'linear-gradient(135deg, #1a0533 0%, #0d0d1a 60%, #0a1520 100%)',
        border: '1.5px solid #2a1a4a', borderRadius: '24px',
        ...
        <div style={{ position: 'relative' }}>
          <div style={{
            ...
            <span style={{ color: '#a78bfa', fontSize: '11px', fontWeight: 600 }}>Testnet actif</span>
          </div>
          <h1 style={{
            fontFamily: "'Syne', 'Montserrat', sans-serif",
          ...
          <p style={{ color: '#7777aa', fontSize: '0.82rem', lineHeight: 1.6, marginBottom: '1.25rem' }}>
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <button onClick={() => navigate('/new-service')} style={{
              ...
              border: '1.5px solid #2a1a4a', borderRadius: '14px',
              padding: '0.75rem', color: '#a78bfa',
      ...
      <div style={{
        ...
        {[
          ...
          <div key={i} onClick={() => navigate(s.path)} style={{
            ...
            <div style={{
              fontFamily: "'Syne', 'Montserrat', sans-serif",
              fontWeight: 800, fontSize: '1.25rem', color: '#fff', marginBottom: '2px',
            }}>{s.value}</div>
            <div style={{ color: '#444466', fontSize: '0.65rem', fontWeight: 600 }}>{s.label}</div>
          </div>
        ))}
      </div>
      ...
      {user && (
        <div style={{ margin: '0 1rem 1.5rem', display: 'flex', gap: '0.75rem' }}>
          {[
            { id: 'buy', icon: '🛍️', title: T.findService || 'Chercher un service', desc: T.findServiceDesc || "Trouvez le talent qu'il vous faut", path: '/marketplace', accent: '#7C3AED' },
            ...
            <div key={card.id}
              ...
              style={{
                flex: 1, background: hoveredCard === card.id ? '#13131f' : '#0f0f1a',
                border: `1.5px solid ${hoveredCard === card.id ? card.accent : '#1a1a2e'}`,
              ...
              <div style={{ fontWeight: 700, fontSize: '0.85rem', color: '#fff', marginBottom: '0.2rem' }}>{card.title}</div>
              <div style={{ fontSize: '0.7rem', color: '#555577' }}>{card.desc}</div>
            </div>
          ))}
        </div>
      )}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.6rem', marginBottom: '1.5rem' }}>
          {categories.map((cat, i) => (
            <div key={cat.key}
              ...
              style={{
                background: hoveredCat === i ? `${cat.accent}12` : '#0f0f1a',
                border: `1.5px solid ${hoveredCat === i ? cat.accent + '55' : '#1a1a2e'}`,
              ...
              <div>
                <div style={{
                  fontFamily: "'Syne', 'Montserrat', sans-serif",
                  fontWeight: 700, fontSize: '0.85rem', color: '#f1f0f8', marginBottom: '2px',
                }}>{cat.label}</div>
                <div style={{ color: '#444466', fontSize: '0.7rem' }}>0 {T.catServices || 'services'}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <div style={{ padding: '0 1rem' }}>
        ...
        {services.length > 0 ? (
                ...
                <div key={s._id}
                  ...
                  <div>
                    ...
                    <h3 style={{
                      ...
                      color: '#f1f0f8', lineHeight: 1.3, margin: '0 0 0.5rem 0',
                    }}>
                      {s.title?.substring(0, isLarge ? 60 : 40)}{s.title?.length > (isLarge ? 60 : 40) ? '…' : ''}
                    </h3>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <span style={{ color: '#9999bb', fontSize: '0.7rem' }}>
                      {s.freelancerId?.username || '—'}
                    </span>
                    <div style={{
                      fontFamily: "'Syne', 'Montserrat', sans-serif",
                      fontWeight: 800, fontSize: isLarge ? '1rem' : '0.875rem', color: '#fff',
                    }}>
          ...
          <div style={{
            background: '#0f0f1a', border: '1.5px dashed #1e1e2e',
            borderRadius: '20px', padding: '2.5rem 1rem',
            textAlign: 'center', marginBottom: '1.5rem',
          }}>
            <div style={{ fontSize: '2rem', marginBottom: '0.75rem' }}>🔍</div>
            <p style={{ color: '#555577', fontSize: '0.85rem', marginBottom: '1rem' }}>
      ...
      <div style={{
        margin: '0 1rem',
        background: 'linear-gradient(135deg, #7C3AED22 0%, #0EA5E911 100%)',
        border: '1.5px solid #7C3AED33', borderRadius: '20px',
        padding: '1.5rem 1.25rem', textAlign: 'center',
      }}>
        <div style={{
          fontFamily: "'Syne', 'Montserrat', sans-serif",
          fontWeight: 800, fontSize: '1.1rem', color: '#fff', marginBottom: '0.5rem',
        }}>Tu as un talent ? 🚀</div>
        <p style={{ color: '#7777aa', fontSize: '0.8rem', marginBottom: '1rem', lineHeight: 1.5 }}>
        ...
        <button onClick={() => navigate('/new-service')} style={{
          ...
          color: '#fff', fontFamily: 'inherit', fontWeight: 700,
          fontSize: '0.875rem', cursor: 'pointer', boxShadow: '0 8px 24px #7C3AED44',
  ...
  return (
    <div className="animate-fade" style={{ padding:'0 0 2rem' }}>
      ...
      <div style={{
        ...
        <div style={{ position:'absolute',top:'-30px',right:'-30px',width:'120px',height:'120px',background:'radial-gradient(circle,#7C3AED33 0%,transparent 70%)',borderRadius:'50%' }} />
        <div style={{
        ...
        <div style={{ flex:1, minWidth:0 }}>
          <h2 style={{ fontFamily:"'Syne','Montserrat',sans-serif", fontWeight:800, fontSize:'1.25rem', color:'#fff', margin:'0 0 4px' }}>{user.username}</h2>
          <span style={{ background:'rgba(124,58,237,0.2)', color:'#a78bfa', border:'1px solid rgba(124,58,237,0.3)', padding:'3px 12px', borderRadius:'100px', fontSize:'11px', fontWeight:700 }}>
            {typeLabel}
          </span>
          <div style={{ display:'flex', gap:'2px', color:'#F59E0B', fontSize:'1rem', marginTop:'6px' }}>
            ...
            <span style={{ color:'#555577', fontSize:'0.75rem', marginRight:'6px' }}>{user.reviews||0} avis</span>
          </div>
        </div>
        {/* Balance */}
        <div style={{ textAlign:'center', flexShrink:0 }}>
          <div style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:'1.5rem', color:'#fff' }}>
            <span style={{ color:'#7C3AED' }}>π</span> {user.balance||0}
          </div>
          <div style={{ color:'#555577', fontSize:'10px', fontWeight:600 }}>BALANCE</div>
        </div>
      </div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:'0.6rem', margin:'0 1rem 1rem' }}>
        {[
          { label: T.servicesSold||'Services vendus', value: user.sales||0, color:'#7C3AED' },
          ...
          <div key={i} style={{ background:'#0f0f1a', border:'1px solid #1a1a2e', borderRadius:'16px', padding:'0.875rem 0.5rem', textAlign:'center' }}>
            <div style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:'1.25rem', color:s.color }}>{s.value}</div>
            <div style={{ color:'#444466', fontSize:'0.6rem', fontWeight:600, marginTop:'2px', lineHeight:1.3 }}>{s.label}</div>
          </div>
        ))}
      </div>

      {/* ── Infos ── */}
      <div style={{ margin:'0 1rem', background:'#0f0f1a', border:'1px solid #1a1a2e', borderRadius:'20px', padding:'1.25rem', marginBottom:'1rem' }}>
        <h3 style={{ fontFamily:"'Syne',sans-serif", fontWeight:700, fontSize:'0.95rem', color:'#f1f0f8', marginBottom:'1rem' }}>{T.infoTitle||'Informations'}</h3>
