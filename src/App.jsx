...
const Header = ({ user, onLogin, onLogout, onSearch, lang, onChangeLang, T, navigate }) => {
  ...
  return (
    <header className="header">
      ...
      <a
        href="/"
        onClick={e => { e.preventDefault(); if (navigate) navigate('/'); }}
        style={{
          display: 'flex',
          alignItems: 'center',
          gap: '0.5rem',
  ...
  return (
    <div className="animate-fade">
      ...
      <div className="stats-grid" style={{marginTop:0,marginBottom:'2rem'}}>
        <Card><div style={{color:'#5A7A8A',fontSize:'0.875rem',marginBottom:'0.5rem'}}>{T.availableBalance}</div><div style={{fontSize:'2rem',fontWeight:800,color:'#06A77D'}}>{earnings?.available||'0.00'} π</div><div style={{fontSize:'0.875rem',color:'#06A77D'}}>{T.readyWithdraw}</div></Card>
        <Card><div style={{color:'#5A7A8A',fontSize:'0.875rem',marginBottom:'0.5rem'}}>{T.pendingBalance}</div><div style={{fontSize:'2rem',fontWeight:800,color:'#FFD166'}}>{earnings?.pending||'0.00'} π</div><div style={{fontSize:'0.875rem',color:'#5A7A8A'}}>{T.inEscrow}</div></Card>
        <Card><div style={{color:'#5A7A8A',fontSize:'0.875rem',marginBottom:'0.5rem'}}>{T.totalEarnings}</div><div style={{fontSize:'2rem',fontWeight:800}}>{earnings?.total||'0.00'} π</div></Card>
        <Card><div style={{color:'#5A7A8A',fontSize:'0.875rem',marginBottom:'0.5rem'}}>{T.feesPaid}</div><div style={{fontSize:'2rem',fontWeight:800,color:'#5A7A8A'}}>{earnings?.fees||'0.00'} π</div></Card>
      </div>
      <Card>
