...
const BACKEND_URL = import.meta.env.VITE_BACKEND_URL || 'https://workpiserv-api-testnet.onrender.com';
...
export async function adminDeleteService(id: string) {
  return apiFetch<{ success: boolean }>(`/api/admin/services/${id}`, { method: 'DELETE' });
}
